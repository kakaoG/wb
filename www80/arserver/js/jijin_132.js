function jijin_132_(){
    ...
    function buildDataList(){
        ...
        var titleArr=["日期","玩家id","玩家姓名","金额变化"];
        var lineW=[200,200,150,120],ws=0;
...
text+='<div class="lists" style="width:'+lineW[1]+'px;">'+data.person_id+'</div>';
text+='<div class="lists" style="width:'+lineW[2]+'px;">'+data.person_name+'</div>';
...
text+='<div class="lists" style="width:'+lineW[3]+'px;">'+data.money_change+'</div>';
    ...
    function start(){
        ...
        exchange_div4_3.addEventListener("click",function(e){
            doLastSend(function(data){
                ...
                downloadFile("消费价值转入基金池.csv",text);
           });
 ...
 server.merchant_add_update(currOpenEdit,merchant_name,merchant_addr,phone,merchant_id,function(data){
    ...
    ajax("html/jijin_132.html",function(text){
